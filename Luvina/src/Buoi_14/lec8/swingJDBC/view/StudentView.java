package Buoi_14.lec8.swingJDBC.view;

import Buoi_14.lec8.swingJDBC.controller.DAO;
...
public class StudentView extends javax.swing.JFrame {
    ...
    public StudentView() {
        ...
        model.setColumnIdentifiers(new Object[]{
            "STT", "ID", "Full Name", "Date of birth"
            , "Address", "Phone number", "Email", "AVG"
        });        
    ...
    public void showTable() {
        for (Student s : list) {
            model.addRow(new Object[]{
                i++, s.getID(), s.getName(), s.getDateOfBirth(), s.getAddress(), s.getPhone(), s.getEmail(), s.getMark()
            });
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            s.setDateOfBirth(new SimpleDateFormat("dd/MM/yyyy").parse(txtdob.getText()));
        } catch (ParseException ex) {
            ex.printStackTrace();
        }
        boolean kt=new DAO().addStudent(s);
        if(kt){
    ...
    JOptionPane.showMessageDialog(null," Value in the cell clicked :"+ " " 
        +jTable1.getValueAt(row,col).toString()); 
    /* Student s=list.get(row);
        txtaddress.setText(s.getAddress());
        txtdob.setText(s.getDateOfBirth().toString());
    ...
    */
        ...
        txtaddress.setText(jTable1.getValueAt(row,1).toString());
        txtid.setText(jTable1.getValueAt(row,2).toString()); 
        txtemail.setText(jTable1.getValueAt(row,3).toString());
        txtphonenumber.setText(jTable1.getValueAt(row,4).toString());
        txtdob.setText(jTable1.getValueAt(row,5).toString());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      public boolean include(Entry entry) {
        // trường cuối cùng
        Float diemTB = (Float) entry.getValue(7);
        // Trường nam
        String sName=(String)entry.getValue(2);        
        return diemTB < 7.0 || sName.contains(hoten);
      }
    };
