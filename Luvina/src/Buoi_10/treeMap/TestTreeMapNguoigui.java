...
public class TestTreeMapNguoigui {
    ...
    public static void main(String args[]) throws ParseException {
       ...
       System.out.println("Sorted by Mã:" + Arrays.toString(tmap.entrySet().toArray()));
        ...
        SortedMap<NguoiGui, Double> tmap1 = new TreeMap<NguoiGui, Double>(new Comparator<NguoiGui>() {
        ...
        tmap2.putAll(tmap);
        System.out.println("Sorted Map by tiền gửi: " + Arrays.toString(tmap2.entrySet().toArray()));
